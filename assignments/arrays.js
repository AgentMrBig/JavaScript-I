...
// Help the dealer find out which car has an id of 33 by logging the car's year, make, and model
// in the console log provided to you below:

var yr = inventory["33"].car_year;
var mk = inventory["33"].car_make;
var md = inventory["33"].car_model;

console.log(`Car 33 is a *car year goes here* *car make goes here* *car model goes here*` );
console.log("Car 33 is a " + yr + " " + mk + " " + md );

// ==== Challenge 2 ====
// The dealer needs the information on the last car in their inventory.
// What is the make and model of the last car in the inventory?  Log the make and model into
// the console.
let lastCar = inventory.length - 1;
var carArr = Object.keys(inventory);
